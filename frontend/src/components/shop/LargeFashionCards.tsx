    ...
    return (
        <div className='w-full my-20 px-2 space-y-4'>
            <div className="w-full flex flex-col items-center md:flex-row justify-center space-y-4 md:space-y-0 space-x-0 md:space-x-10 md:p-10">
                <GenderCard type='woman' url='/products/woman/best-seller' description={"Woman's Fashion"} image={'/woman2.png'} />
                <GenderCard type='man' url='/products/man/best-seller' description={"Man's Fashion"} image={'/man2.png'} />
            </div>
            <div className="w-full flex justify-center">
                <Link href={'/products/kids/best-seller'} className=" bg-red-200 w-full max-w-[400px]  relative aspect-[5/7] overflow-hidden ">
